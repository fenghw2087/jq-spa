...
export default class Dropdown {
     ...
     */
    constructor({obj={}, placeholder='请选择', list=[], renderLi, renderSecLi, activeIndex=-1, activeSecIndex=-1, beforeClick=()=>{}, onSelectChange=()=>{}, hasReset = false, hasChildren = false, menuStyle='max-height:300px;overflow-y:auto', dropup, disabled, autoShow, btnStyle='', hasSearch }) {
        this.obj = obj;
